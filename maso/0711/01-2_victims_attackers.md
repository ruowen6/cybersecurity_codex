Information and threats > Personal aspects of threats >> Some victims and attackers
# 笔记区
...
1. Unpredictably modified scripts, which can therefore be particularly dangerous.
...
1. acting as apprentices and assistants to more experienced actors.
...
1. means that an attacker changes someones credentials at a service so that the victim is blocked out.
...
1. Inferring sensitive personal or organizational information from discarded papers and media together with public sources.
...
1. a new identity has been assigned to a user.
